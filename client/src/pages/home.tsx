      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between h-20">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold font-heading text-foreground">WashMaster</span>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-heading leading-tight text-foreground">
              Schedule jobs, track routes, <span className="text-primary">manage customers.</span>
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-lg">
              The all-in-one platform built specifically for mobile car wash businesses to save time and grow revenue.
            </p>
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Stop juggling spreadsheets and text messages. WashMaster gives you a professional command center.
          </p>
        </div>
          ...
          <div className="bg-primary/5 rounded-3xl p-8 md:p-12 border border-primary/10 flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 text-left">
              ...
              <p className="text-lg text-muted-foreground mb-6">
                No hidden fees. No long-term contracts. Just one fair price for all features.
              </p>
            ...
            <div className="w-full md:w-80 bg-white rounded-2xl p-8 shadow-xl border border-border flex flex-col items-center text-center relative overflow-hidden">
              <div className="absolute top-0 w-full h-2 bg-primary" />
              <h3 className="text-lg font-semibold text-muted-foreground mb-2">Pro Plan</h3>
              <div className="flex items-baseline gap-1 mb-6">
                <span className="text-4xl font-bold text-foreground">$29</span>
                <span className="text-muted-foreground">/month</span>
              </div>
              <Button className="w-full mb-4 h-12 text-base">Start 14-Day Free Trial</Button>
...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "WashMaster works on any device with a web browser. It's optimized for mobile use on smartphones (iOS and Android) and tablets, as well as desktop computers."
    },
    {
    ...
    <section className="py-24 bg-foreground text-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
        ...
        <p className="text-xl text-gray-300 max-w-2xl mx-auto mb-10">
          Join hundreds of mobile car wash businesses saving time and growing faster with WashMaster.
        </p>
    ...
    <footer className="bg-background border-t py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold font-heading text-lg">WashMaster</span>
            </div>
            <p className="text-sm text-muted-foreground">
              Built for pros who want to focus on the wash, not the paperwork.
            </p>
          </div>
        ...
        <div className="pt-8 border-t flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          <p>© 2024 WashMaster Inc. All rights reserved.</p>
