              ...
              <div className="max-w-2xl">
                ...
                <div className="flex items-center gap-2 text-sm text-muted-foreground font-medium">
                  <div className="flex -space-x-2">
                    <img src="https://images.pexels.com/photos/6873136/pexels-photo-6873136.jpeg" alt="Testimonial 1" className="w-8 h-8 rounded-full object-cover border-2 border-background" />
                    <img src="https://images.pexels.com/photos/30004312/pexels-photo-30004312.jpeg" alt="Testimonial 2" className="w-8 h-8 rounded-full object-cover border-2 border-background" />
                    <img src="https://dl4.pushbulletusercontent2.com/Aqp3f5T0LcJmYiFjdXBLpPt2ODZdsmVC/image.png" alt="Testimonial 3" className="w-8 h-8 rounded-full object-cover border-2 border-background" />
                  </div>
